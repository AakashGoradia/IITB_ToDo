...
const Card = ({ title, id, column, description, handleDragStart, handleDeleteCard }) => {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="mr-2 inline-flex items-center px-4 py-2 border border-red-300 shadow-sm text-sm font-medium rounded-md text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
                  Delete
                </button>
                <button
